...
library_benchmark_group!(name = evaluate_namespaced; benchmarks = iai_namespaced_depth_4_deny);

main!(library_benchmark_groups = evaluate_namespaced);
