...
pub trait CedarAtom {
    /// The Cedar typename (“User”, “Action”, “Group”, etc), possibly
    /// including a scope qualifier like “User::Application”.
    fn cedar_type() -> &'static str;

    /// Build a Cedar parent type for this atom
    ...
    /// The raw ID string (e.g. “alice” or “create_host”)
